...
@NamedQueries({
    ...
    @NamedQuery(name = "ItemproductoView.findByCodeAndName", query = "SELECT i FROM ItemproductoView i WHERE i.idempresa = :idempresa and (LOWER(i.nombre) like LOWER(:nombre) or i.codigo like :codigo) order by i.nombre")})
