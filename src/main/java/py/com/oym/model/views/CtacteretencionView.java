 ...
 */
@Entity
@Table(name = "ctacteretencion_view")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CtacteretencionView.findAll", query = "SELECT c FROM CtacteretencionView c")
    , @NamedQuery(name = "CtacteretencionView.findByIdctactemovimiento", query = "SELECT c FROM CtacteretencionView c WHERE c.idctactemovimiento = :idctactemovimiento")
    , @NamedQuery(name = "CtacteretencionView.findByIddocumento", query = "SELECT c FROM CtacteretencionView c WHERE c.iddocumento = :iddocumento")
    , @NamedQuery(name = "CtacteretencionView.findByIddocumentotipo", query = "SELECT c FROM CtacteretencionView c WHERE c.iddocumentotipo = :iddocumentotipo")
    , @NamedQuery(name = "CtacteretencionView.findByIdctacte", query = "SELECT c FROM CtacteretencionView c WHERE c.idctacte = :idctacte")
    
    })

public class CtacteretencionView implements Serializable {
    ...
    @Column(name = "montocomptotal")
    private BigDecimal montocomptotal;
    @Column(name = "montocompimpuesto")
    private BigDecimal montocompimpuesto;
    @Size(max = 100)
    @Column(name = "conceptotesaka")
    private String conceptotesaka;
    @Size(max = 20)
    @Column(name = "situaciontesaka")
    private String situaciontesaka;

    public CtacteretencionView() {
    }
    ...
    public BigDecimal getMontocomptotal() {
        return montocomptotal;
    }

    public void setMontocomptotal(BigDecimal montocomptotal) {
        this.montocomptotal = montocomptotal;
    }

    public BigDecimal getMontocompimpuesto() {
        return montocompimpuesto;
    }

    public void setMontocompimpuesto(BigDecimal montocompimpuesto) {
        this.montocompimpuesto = montocompimpuesto;
    }

    public String getConceptotesaka() {
        return conceptotesaka;
    }

    public void setConceptotesaka(String conceptotesaka) {
        this.conceptotesaka = conceptotesaka;
    }

    public String getSituaciontesaka() {
        return situaciontesaka;
    }

    public void setSituaciontesaka(String situaciontesaka) {
        this.situaciontesaka = situaciontesaka;
    }
