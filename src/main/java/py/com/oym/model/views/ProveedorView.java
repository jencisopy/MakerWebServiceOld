...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ProveedorView.findAll",        query = "SELECT c FROM ProveedorView c where c.idempresa = :idempresa"),
    @NamedQuery(name = "ProveedorView.findByIdctacte", query = "SELECT c FROM ProveedorView c WHERE c.idctacte  = :idctacte"),
    @NamedQuery(name = "ProveedorView.findByIdempresa",query = "SELECT c FROM ProveedorView c WHERE c.idempresa = :idempresa"),
    @NamedQuery(name = "ProveedorView.findByCodigo",   query = "SELECT c FROM ProveedorView c WHERE c.idempresa = :idempresa and c.codigo = :codigo"),
    @NamedQuery(name = "ProveedorView.findByRuc",      query = "SELECT c FROM ProveedorView c WHERE c.ruc = :ruc")})
